...
See [docs/troubleshooting/longhorn.md](../../docs/troubleshooting/longhorn.md) for real incidents during setup: PodSecurity requirements, replica count gotchas, Talos system extensions, and kubelet extraMounts.
