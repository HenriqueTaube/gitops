...
| [Cloudflare Tunnel](https://www.cloudflare.com/products/tunnel/) | External access | Exposes applications publicly without opening ports on the home network. Creates an outbound connection from the cluster to Cloudflare, making apps accessible at a public domain (e.g. [agente.taubekube.com](https://agente.taubekube.com)) with automatic HTTPS. |
