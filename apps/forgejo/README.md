...
See [docs/troubleshooting/forgejo.md](../../docs/troubleshooting/forgejo.md) for the full migration story: VM → local-path → NFS → Longhorn, including MariaDB collation issues, nested data directory, and Multi-Attach errors.
